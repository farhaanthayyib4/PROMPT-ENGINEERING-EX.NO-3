...
## Prompt Engineering Types with Examples
...
To write prompts for the following prompt engineering techniques and evaluate their outputs using an AI model.
...
| Usage        | Used in household power supply          | Used in batteries and electronics |
| Transmission | Suitable for long-distance transmission | Less efficient for long distance  |
